...
| Spacing 그리드 | **4px 기반 그리드, 8px가 기본 스텝.** 허용값: 4·8·12·16·20·24·32… <br>*(2026-09-05 정정: 원래 "8px, 4는 아이콘 간격만 예외"였으나 A단계에서 12px 위반이 112건 나왔다. 산발이 아니라 파일 전반에 일관돼 있어 산출물이 아니라 기준이 틀린 경우로 판정 — 실제 설계는 4pt 그리드였다.)* |
